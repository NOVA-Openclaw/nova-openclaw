...
// Imported AND re-exported from session-entry-types.ts (#111 C5 architecture
// fix) so existing importers of these types from session-manager.js keep
// working unchanged. See session-entry-types.ts's module doc for why these
// type declarations were extracted to their own leaf module.
import type {
